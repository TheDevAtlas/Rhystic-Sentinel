...
public class StableDiffusionText2Image : StableDiffusionGenerator
{
    ...
    public SpriteRenderer standard;
    public SpriteRenderer fullArt;
    ...
    void Update()
    {
        ...
        if(!isFullArt){
            ...
            fullArt.gameObject.SetActive(false);
    ...
    IEnumerator GenerateAsync()
    {
        ...
        try
        {
            ...
            httpWebRequest.Timeout = 30000000;
    ...
    void LoadIntoImage(Texture2D texture)
    {
        try
        {
            ...
            else
            {
                ...
                standard.sprite = sprite;
                fullArt.sprite = sprite;
            }
